...
var EmailTemplates map[string]EmailTemplateTypes = map[string]EmailTemplateTypes{
	...
	"welcoming": {
		en: TemplateType{Path: "util/mailing/templates/welcoming/welcoming_en.html", Subject: "Thank You for Joining Moniesto!"},
		tr: TemplateType{Path: "util/mailing/templates/welcoming/welcoming_tr.html", Subject: "Moniesto'ya Katıldığınız İçin Teşekkürler!"},
	},
	"password-reset": {
